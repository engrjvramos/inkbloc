      ...
      <div className="no-scrollbar flex gap-px overflow-x-auto border-b">
        {lists.map(({ id, title, _count }) => (
          <Button
            ...
            className={cn(
              'text-muted-foreground relative h-auto rounded-t-md rounded-b-none border-0 px-4 py-3',
              id === selectedListId &&
          ...
          >
            ...
            {_count.todos > 0 && (
              <span className="text-muted-foreground bg-input inline-flex size-5 items-center justify-center rounded-full font-mono text-xs">
                {_count.todos}
              </span>
            )}
          </Button>
